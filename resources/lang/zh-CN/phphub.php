...
return [
    ...
    'Voted Topics' => '赞过的话题',
    'Up Votes' => '点赞',
    'You dont have permission to proceed.' => '很抱歉, 当前用户没有权限继续操作. <br>如有疑问请联系管理员.',
    ...
    'Sorry, You account is banned.' => '对不起，您的账号已被禁用！<br>如有疑问，请直接联系社区管理员。',
    'All Categories' => '分类导航',
    ...
    'GitHub Name likes: summerblue' => '如：pcdotfan',
    'Email example: name@website.com' => '如：pcdotfan@aliyun.com',
    'Real Name example: 李小明' => '如：李小明',
    'City example: BeiJing' => '如：北京、广州',
    'Company example: Alibaba' => '如：阿里巴巴',
    'Weibo Username example: PHPHub' => '如：PCDotFan',
    'Weibo ID example: 5963322692' => '用来拼接 URL 的，如：5963322692',
    'twitter_placeholder_hint' => '如：summer_charlie',
    'personal_website_placebolder_hint' => '如：example.com，不需要加前缀 (http://)',
    'introduction_placeholder_hint' => '请用一句话介绍你自己',
    'User ID:' => '用户 ID:',
    'Real Name' => '真实姓名',
    'Company' => '公司',
    'City' => '城市',
...
>>>>>>> summerblue/master
    ...
    'Congratulations and Welcome!' => '恭喜，您已经成功加入 MakerPlus。',
    ...
    'Setup multiple Bindings allow you to login to the same account with different binding site account.' => '绑定多个第三方账号，允许你使用任意一个第三方账号登录同一个 MakerPlus 账号。',

    'Photo Upload' => '上传头像',
    'Selected image:' => '请选择图片：',
    'Uploading image...' => '图片上传中...',
    'Update Avatar Success' => '已成功上传头像。',
    ...
    'The mail send failed! Please try again in 60 seconds.' => '邮件发送失败：执行此操作过于频繁，请于 :seconds 秒后重试',
    'The mail send failed! Please fill in your email address first.' => '邮箱不存在，请点击 <a href="' .url(route('users.edit', \Auth::id())). '" target="_blank">此处</a> 编辑您的邮箱。',
    ...
    'Bind Successfully!' => '绑定成功！今后您可以使用 :driver 账号登录 MakerPlus 了 ^_^',
    'Actived' => '最近访问',
];
